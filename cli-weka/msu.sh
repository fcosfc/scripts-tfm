...
DEFAULT_WEKA_BASE=$(dirname $PWD)/weka-stable-3-8/weka
WEKA_VERSION=3.8.7-SNAPSHOT.jar
WEKA_DIST=$DEFAULT_WEKA_BASE/dist/weka-stable-$WEKA_VERSION

DATASET_DIR=$(dirname $DEFAULT_WEKA_BASE)/wekadocs/data
